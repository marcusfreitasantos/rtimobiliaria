...
<section id="contato">
    <div class="container">
        ...
        <div class="mensagem-erro col-md-12 alerta">
            <h6><i class="far fa-check-circle"></i>Algo deu errado! Reenvie novamente em alguns instantes ou entre em contato pelo nosso telefone: (79) 3222-0000</h6>
        </div>
    </div>
</section>
